...
export default function GameItems() {
    ...
    return (
        ...
        <EditGameInforModalWithoutGenre show={show} handleClose={handleClose} title="Vật phẩm" content="Điểm số: Người chơi nhận được điểm dựa trên độ chính xác và thời gian trả lời. Câu trả lời nhanh và chính xác hơn sẽ nhận được nhiều điểm hơn." />
        </>
    )
}