  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        cell: "tw-h-9 tw-w-9 tw-text-center tw-text-sm tw-p-0 tw-relative [&:has([aria-selected].day-range-end)]:tw-rounded-r-md [&:has([aria-selected].day-outside)]:tw-bg-slate-100/50 [&:has([aria-selected])]:tw-bg-slate-100 first:[&:has([aria-selected])]:tw-rounded-l-md last:[&:has([aria-selected])]:tw-rounded-r-md focus-within:tw-relative focus-within:tw-z-20 dark:[&:has([aria-selected].day-outside)]:tw-bg-slate-800/50 dark:[&:has([aria-selected])]:tw-bg-slate-800",
        day: cn(
        ...
        day_outside:
          "tw-day-outside tw-text-slate-500 tw-opacity-50 aria-selected:tw-bg-slate-100/50 aria-selected:tw-text-slate-500 aria-selected:tw-opacity-30 dark:tw-text-slate-400 dark:aria-selected:tw-bg-slate-800/50 dark:aria-selected:tw-text-slate-400",
